...
export const RAY_HELP_DEFS = {
    ...
    RayPixelArtDetector: {
        ...
        sections: [
            ...
            { heading: "Palette mapping", body: "palette_strategy builds the palette; palette_mapping assigns pixels to it. Mapping stays available with a supplied palette. auto keeps recent behavior; legacy_oklab restores original near-black handling; oklab and lab use perceptual distances; rgb uses channel distance; color_families prefers matching hue groups. All emit only palette colors. The grid uses this choice for all generated methods." },
